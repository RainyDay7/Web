...
<div id="join_box" style="border: #eee solid 3px;opacity:0.8;">
    <div id="Member_join">添加商品</div>
    <div id="regForm" style="text-align: center">
        <form id="imm" action="/ProductServlet.do?key=1" method="post" >
            <span class="span1">商品名称：</span>
            <input class="input1" tabindex="1" type="text" onblur="cheackpname()" name="pname" id="pname" placeholder="请输入商品名称 ，3~12字" autocomplete="off">
            <br>
            <span class="span1">商品单价：</span>
            <input class="input1" tabindex="2" type="text" onblur="cheackprice()" name="price" id="price" placeholder="请输入商品单价，字母开头6~16字" autocomplete="off" style="margin-bottom: 20px">
            <br>
            <span class="span1" style="margin-right: 20px">商品图片：</span>
            <img id="img" src="" width="100px" height="100px" style="margin-right: 20px; border: 3px pink solid"><!-- 显示图片的 -->
            ...
            <input class="input1" tabindex="5" type="text" onblur="checkdesc()" name="pdesc" id="pdesc" placeholder="请输入商品描述" autocomplete="off">
            <br>
